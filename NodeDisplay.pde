...
class NodeDisplay
{
  ...
  NodeDisplay( int id )
  {
    ...
    conduitLength[21] = 570;
    conduitLength[22] = 540;
    conduitLength[23] = 460;
    conduitLength[24] = 460;
    conduitLength[25] = 440;
    conduitLength[26] = 420;
    conduitLength[27] = 410;
    conduitLength[28] = 410;
    
    conduitLength[29] = 420;
    conduitLength[30] = 440;
    
    conduitLength[31] = 460;
    conduitLength[32] = 460;
    conduitLength[33] = 540;
    conduitLength[34] = 570;
    conduitLength[35] = 670;
    conduitLength[36] = 720;
